...
export function ExperimentsSection({ isDark }: { isDark?: boolean }) {
    ...
    return (
        <section className="relative w-[100vw] max-w-[100vw] md:max-w-[900px] mx-auto flex flex-col items-center justify-center min-h-[90vh] md:min-h-[80vh] py-20 px-4 overflow-visible z-10">
            <div className="relative w-full flex flex-col items-center justify-center">
                {/* Floating Images (Responsive positions and dimensions) */}

                {/* Top Left */}
                <motion.div
                    className="absolute -top-12 -left-[40px] md:-top-10 md:left-12 w-[140px] h-[180px] md:w-[160px] md:h-[200px] rounded-[14px] shadow-xl overflow-hidden border-2 border-white z-0 cursor-zoom-in"
                ...
                {/* Top Right */}
                <motion.div
                    className="absolute -top-20 -right-[30px] md:-top-16 md:right-16 w-[140px] h-[190px] md:w-[160px] md:h-[200px] rounded-[14px] shadow-xl overflow-hidden border-2 border-white z-0 cursor-zoom-in"
                    initial={{ rotate: -10, y: 30, opacity: 0 }}
                ...
                {/* Center Left */}
                <motion.div
                    className="absolute top-[160px] md:top-[120px] -left-[60px] md:-left-8 w-[150px] h-[200px] md:w-[150px] md:h-[190px] rounded-[14px] shadow-xl overflow-hidden border-2 border-white z-20 cursor-zoom-in"
                ...
                {/* Center Right */}
                <motion.div
                    className="absolute top-[140px] md:top-[130px] -right-[70px] md:-right-4 w-[150px] h-[200px] md:w-[150px] md:h-[190px] rounded-[14px] shadow-xl overflow-hidden border-2 border-white z-20 cursor-zoom-in"
                    initial={{ rotate: 5, x: -30, opacity: 0 }}
                ...
                {/* Bottom Left */}
                <motion.div
                    className="absolute top-[380px] md:top-[300px] -left-[50px] md:left-20 w-[140px] h-[190px] md:w-[150px] md:h-[190px] rounded-[14px] shadow-xl overflow-hidden border-2 border-white z-10 cursor-zoom-in"
                ...
                {/* Bottom Right */}
                <motion.div
                    className="absolute top-[400px] md:top-[280px] -right-[40px] md:right-24 w-[150px] h-[200px] md:w-[160px] md:h-[200px] rounded-[14px] shadow-xl overflow-hidden border-2 border-white z-10 cursor-zoom-in"
                    initial={{ rotate: 0, y: -30, opacity: 0 }}
                    whileInView={{ rotate: -15, y: 0, opacity: 1 }}
                    whileHover={{ scale: 1.05, rotate: -19, zIndex: 50, boxShadow: "0 15px 35px rgba(0,0,0,0.4)" }}
                ...
                <div className={`flex flex-col items-center justify-center text-center max-w-[450px] z-30 pt-32 pb-32 md:py-32 h-[500px] md:h-auto ${poppins.className}`}>
                    <h2
                        className="text-[15px] md:text-[32px] leading-[1.2] tracking-tight mb-2 font-medium transition-all duration-700 capitalize"
                        style={{
                    ...
                    >
                        ...
                        <span className="font-bold text-[21px] md:text-[42px] lowercase z-[35]">i make, and do.</span>
                    </h2>
                    <p className={`mt-2 tracking-[1.5px] text-[10px] md:text-[14px] uppercase font-semibold transition-colors duration-700 ${isDark ? 'text-[#a4a4a4]' : 'text-[#bc5100]'}`}>
                        [Experiments]
                    </p>
                </div>
            </div>
            ...
            {mounted && zoomedImage && createPortal(
                ...
                >
                    <div className="relative w-full max-w-lg md:max-w-2xl h-[70vh] md:h-[80vh]">
                        <Image
                            src={zoomedImage}
