    ...
    return (
        <section className="relative w-[100vw] max-w-[100vw] sm:max-w-[900px] mx-auto flex flex-col items-center justify-center min-h-screen px-4 overflow-visible z-10">
            <div className="relative w-full flex flex-col items-center justify-center">
                ...
                {/* Top Left */}
                <motion.div
                    className="absolute -top-12 -left-[40px] sm:-top-10 sm:left-12 w-[140px] h-[180px] sm:w-[160px] sm:h-[200px] rounded-[14px] shadow-xl overflow-hidden border-2 border-white z-0 cursor-zoom-in"
                ...
                {/* Top Right */}
                <motion.div
                    className="absolute -top-20 -right-[30px] sm:-top-16 sm:right-16 w-[140px] h-[190px] sm:w-[160px] sm:h-[200px] rounded-[14px] shadow-xl overflow-hidden border-2 border-white z-0 cursor-zoom-in"
                    initial={{ rotate: -10, y: 30, opacity: 0 }}
                ...
                {/* Center Left */}
                <motion.div
                    className="absolute top-[160px] sm:top-[120px] -left-[60px] sm:-left-8 w-[150px] h-[200px] sm:w-[150px] sm:h-[190px] rounded-[14px] shadow-xl overflow-hidden border-2 border-white z-20 cursor-zoom-in"
                ...
                {/* Center Right */}
                <motion.div
                    className="absolute top-[140px] sm:top-[130px] -right-[70px] sm:-right-4 w-[150px] h-[200px] sm:w-[150px] sm:h-[190px] rounded-[14px] shadow-xl overflow-hidden border-2 border-white z-20 cursor-zoom-in"
                    initial={{ rotate: 5, x: -30, opacity: 0 }}
                ...
                {/* Bottom Left */}
                <motion.div
                    className="absolute top-[380px] sm:top-[300px] -left-[50px] sm:left-20 w-[140px] h-[190px] sm:w-[150px] sm:h-[190px] rounded-[14px] shadow-xl overflow-hidden border-2 border-white z-10 cursor-zoom-in"
                ...
                {/* Bottom Right */}
                <motion.div
                    className="absolute top-[400px] sm:top-[280px] -right-[40px] sm:right-24 w-[150px] h-[200px] sm:w-[160px] sm:h-[200px] rounded-[14px] shadow-xl overflow-hidden border-2 border-white z-10 cursor-zoom-in"
                    initial={{ rotate: 0, y: -30, opacity: 0 }}
                    whileInView={{ rotate: -15, y: 0, opacity: 1 }}
                    whileHover={{ scale: 1.05, rotate: -19, zIndex: 50, boxShadow: "0 15px 35px rgba(0,0,0,0.4)" }}
